...
| 色卡 | 色数 | 说明 |
| --- | ---: | --- |
| **樱花** | 600 | 2026-09-26 使用最新 5 张实拍色卡重新提取全部 QQ001–TQ600，旧版色值已替换 |
| **涵特** | 720 | HANTE 120D/2 高速绣花线色卡，现已完整录入 001–720 |
| **亚丽丝** | 1680 | 12 张实拍色卡整理；101、102、1786 已按新增近照校准，AL 内部编号保持不变 |
...
- GitHub Pages 静态部署；
- 支持 PWA / 离线缓存；
- 页面使用不蒜子（Busuanzi）显示站点总 PV / UV；该第三方统计脚本只用于访问量统计，图片与项目数据仍在本地处理。
